...
@protected List<LogEntry> dco_decode_list_log_entry(dynamic raw);

@protected Uint8List dco_decode_list_prim_u_8_strict(dynamic raw);

@protected List<(String,String)> dco_decode_list_record_string_string(dynamic raw);

@protected List<Session> dco_decode_list_session(dynamic raw);

@protected LogEntry dco_decode_log_entry(dynamic raw);

@protected LogStats dco_decode_log_stats(dynamic raw);
...
@protected Session dco_decode_session(dynamic raw);
...
@protected List<LogEntry> sse_decode_list_log_entry(SseDeserializer deserializer);

@protected Uint8List sse_decode_list_prim_u_8_strict(SseDeserializer deserializer);

@protected List<(String,String)> sse_decode_list_record_string_string(SseDeserializer deserializer);

@protected List<Session> sse_decode_list_session(SseDeserializer deserializer);

@protected LogEntry sse_decode_log_entry(SseDeserializer deserializer);

@protected LogStats sse_decode_log_stats(SseDeserializer deserializer);
...
@protected Session sse_decode_session(SseDeserializer deserializer);
...
@protected void sse_encode_list_log_entry(List<LogEntry> self, SseSerializer serializer);

@protected void sse_encode_list_prim_u_8_strict(Uint8List self, SseSerializer serializer);

@protected void sse_encode_list_record_string_string(List<(String,String)> self, SseSerializer serializer);

@protected void sse_encode_list_session(List<Session> self, SseSerializer serializer);
...
@protected void sse_encode_session(Session self, SseSerializer serializer);
